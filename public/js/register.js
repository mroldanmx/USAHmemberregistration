...
/***/ "./resources/js/address_autocomplete.js":
/*!**********************************************!*\
  !*** ./resources/js/address_autocomplete.js ***!
  \**********************************************/
 ...
 * @param zip
 */
var address_autocomplete = function address_autocomplete(zip) {
  console.log('trying...', zip);
  return fetch('https://ziptasticapi.com/' + zip).then(function (r) {
    return r.json();
  }).then(function (res) {
    return res;
  });
...
/* harmony default export */ __webpack_exports__["default"] = (address_autocomplete);
...
/* harmony import */ var _registration__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./registration */ "./resources/js/registration.js");
/* harmony import */ var _address_autocomplete__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./address_autocomplete */ "./resources/js/address_autocomplete.js");
...
var toggle_terms_visibility = function toggle_terms_visibility(member_type) {
  //hide all terms
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-membership-requirement').hide(); //show terms of the selected membership

  jquery__WEBPACK_IMPORTED_MODULE_1___default()("[data-term-id=".concat(member_type, "]")).show();
}; //show the Membership requirements when the user changes selection


jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('change', '[name="will_donate"]', function () {
  var val = parseInt(jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val());
  console.log({
    val: val
  });

  if (val) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#donations').show();
  } else {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('#donations').hide();
  }
});
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('change', '[name="member_type_id"]', function () {
  var member_type = jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val();
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#membership-requirements-checkbox').show();
  jquery__WEBPACK_IMPORTED_MODULE_1___default()('#membership-requirements-checkbox').removeAttr('checked');
  toggle_terms_visibility(member_type);

  if (member_type == 3) {
    jquery__WEBPACK_IMPORTED_MODULE_1___default()('.js-child').addClass('hidden');
  } else {
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).on('focusout', '.js-zipcode',
/*#__PURE__*/
_asyncToGenerator(
/*#__PURE__*/
  ...
  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.next = 2;
          return Object(_address_autocomplete__WEBPACK_IMPORTED_MODULE_3__["default"])(jquery__WEBPACK_IMPORTED_MODULE_1___default()(this).val());
...
jquery__WEBPACK_IMPORTED_MODULE_1___default()(document).ready(function () {
  ...
  var member_type_input = jquery__WEBPACK_IMPORTED_MODULE_1___default()('[type=radio][checked]');
  ...
  var donation_type_input = jquery__WEBPACK_IMPORTED_MODULE_1___default()('[name="will_donate"][checked]');
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()('form#registrationForm').on('submit', function () {
  var dob = jquery__WEBPACK_IMPORTED_MODULE_0___default()(this).find('[name="dob"]');

  if (dob) {
    var year = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="dob_year"]').val();
    var month = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="dob_month"]').val();
    var day = jquery__WEBPACK_IMPORTED_MODULE_0___default()('[name="dob_day"]').val();
    dob.val("".concat(year, "-").concat(month, "-").concat(day));
  }
});
