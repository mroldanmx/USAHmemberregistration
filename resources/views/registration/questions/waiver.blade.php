    ...
    <div class="row">
        <div class="col-md-offset-0 col-md-12" style="text-align: center;">
            ...
            <div class="object checkbox">
                ...
                <label style="padding-left: 1em;" class="text-left">
                    <input value="1" name="waiver_check" type="checkbox" required>
                    <span class="checkmark w-30 h-30"></span>

                    I <input
                            class="sign-with-initials h-30"
                            value="{{old('waiver_agree',$reg->waiver_agree)}}"
                            name="waiver_agree"
                            type="text" maxlength="2"/><span class="ml-70">have read and accept the USA Hockey Waiver of Liability </span><span
                            class="required">*</span>
                </label>
