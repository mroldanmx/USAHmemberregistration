...
<section class="content">
    <form class="form-horizontal view-form" id="memberEditForm" method="POST" action="{{ route('admin.registrations.update', $registration->id) }}">
        <div class="col-md-6">
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group @if($errors->has('first_name')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name', $registration->member->first_name) }}" disabled="">
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('last_name')) has-error @endif">
                        <label for="last_name" class="col-sm-3 control-label">Last Name</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name', $registration->member->last_name) }}" disabled="">
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('dob')) has-error @endif">
                        <label for="dob" class="col-sm-3 control-label">Date of Birth</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="dob" name="dob" value="{{ old('last_name', $registration->member->dob) }}" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('gender')) has-error @endif">
                        <label class="col-sm-3 control-label">Gender</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="dob" name="dob" value="@if($registration->member->gender === 'M') Male @elseif($registration->member->gender === 'F') Female @endif" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('member_type_id')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            ...
                            @if($registration->member_type_id === $typeID)
                            <input type="text" class="form-control" id="dob" name="dob" value="{{ $typeName }}" disabled>
                            @endif
                            @endforeach
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('member_diversity')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="diversity" name="member_diversity" placeholder="" disabled>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="box box-info">
                ...
                <div class="box-body">
                    <div class="form-group @if($errors->has('email')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input type="email" class="form-control" id="email" name="email" value="{{ old('email', $registration->member->email) }}" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('phone_1')) has-error @endif">
                        <label for="phone_1" class="col-sm-3 control-label">Phone</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="phone_1" name="phone_1" value="{{ old('phone_1', $registration->member->phone_1) }}" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('phone_2')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="phone_2" name="phone_2" value="{{ old('phone_2', $registration->member->phone_2) }}" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('line_1')) has-error @endif">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="line_1" name="line_1" value="{{ old('line_1', $registration->member->address->line_1) }}" disabled>
                        </div>
                    </div>
                    <div class="form-group @if($errors->has('city')) has-error @endif">
                        <label for="address_city" class="col-sm-3 control-label">City</label>
                        <div class="col-sm-9">
                            <input type="text" class="form-control" id="city" name="city" value="{{ old('city', $registration->member->address->city) }}" disabled>
                        </div>
                    </div>
